...
class TableViewControllerToDo: UITableViewController {

    

    
    @IBAction func refreshToDo(_ sender: UIRefreshControl) {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        var uncompletedArrayFalse = uncompletedArray()
        let currentItem = uncompletedArrayFalse[indexPath.row]
        
           if (currentItem["isCompleted"] as? Bool) == false {
