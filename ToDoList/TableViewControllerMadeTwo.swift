//
//  TableViewControllerMadeTwo.swift
//  ToDoList
//
//  Created by 12dot on 15.12.2019.
//  Copyright © 2019 12dot. All rights reserved.
//

import UIKit

class TableViewControllerMadeTwo: UITableViewController {
    ...
    @IBAction func refreshMade(_ sender: UIRefreshControl) {
        ...
        sender.endRefreshing()
            ...
            override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
                let cell = tableView.dequeueReusableCell(withIdentifier: "CellMadeAgain", for: indexPath)

                var completedArrayTrue = completedArray()
                let currentItem = completedArrayTrue[indexPath.row]
